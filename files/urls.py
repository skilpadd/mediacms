...
urlpatterns = [
    ...
    re_path(r"^add_subtitle/(?P<friendly_token>[\w_-]*)$", views.add_subtitle, name="add_subtitle"),
    ...
    re_path(r"^publish/(?P<friendly_token>[\w_-]*)$", views.publish_media, name="publish_media"),
    re_path(r"^edit_chapters/(?P<friendly_token>[\w_-]*)$", views.edit_chapters, name="edit_chapters"),
    re_path(r"^replace_media/(?P<friendly_token>[\w_-]*)$", views.replace_media, name="replace_media"),
    re_path(r"^edit_video/(?P<friendly_token>[\w_-]*)$", views.edit_video, name="edit_video"),
    re_path(r"^edit/(?P<friendly_token>[\w_-]*)$", views.edit_media, name="edit_media"),
    re_path(r"^embed/(?P<friendly_token>[\w_-]*)$", views.embed_media, name="get_embed"),
